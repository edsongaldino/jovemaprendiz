            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-30">
                        ...
                        <p class="text">Selecione abaixo o tipo de cadastro que deseja realizar</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="contact-wrapper form-style-two"></div>
                        ...
                        <div class="nav nav-tabs cad-menu" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><i class="lni lni-user"></i> Quero ser Aprendiz</a>
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="lni lni-restaurant"></i> Quero Contratar Aprendiz</a>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-input mt-25">
                                                <label>CPF</label>
                                                <div class="input-items default">
                                                    <input name="name" type="text" placeholder="CPF">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-input mt-25">
                                                ...
                                                <div class="input-items default">
                                                    <input type="email" name="email" placeholder="00/00/0000">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-input light-rounded-buttons mt-30">
                                                <button class="main-btn light-rounded-two">Quero ser jovem aprendiz</button>
                                            </div> <!-- form input -->
                                        </div>
                                    </div> <!-- row -->
                                </form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-input mt-25">
                                                ...
                                                <div class="input-items default">
                                                    <input name="cnpj_cei" type="text" placeholder="">
                                                    <i class="lni lni-more"></i>
                                                </div>
                                            </div> <!-- form input -->
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-input light-rounded-buttons mt-30">
                                                <button class="main-btn light-rounded-two">Quero contratar aprendizes</button>
                                            </div> <!-- form input -->
                                        </div>
                                    </div> <!-- row -->
                                </form>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-30">
                        ...
                        <p class="text">Entre em contato conosco pelo formulário abaixo ou pela nossas redes sociais</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="footer-logo text-center">
                        <a class="mt-30" href="index.php"><img src="assets/images/logo.png" alt="Logo"></a>
                    </div> <!-- footer logo -->
                    ...
                    <div class="copyright text-center mt-35">
                        <a class="mt-30" href="index.php"><img src="assets/images/logo-datapix.png" alt="Logo"></a>
                    </div> <!--  copyright -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
