...
<html lang="pt-br">
  <head>
    ...
    <link href="{{ asset('/assets/sistema/lib/perfect-scrollbar/css/perfect-scrollbar.css') }}" rel="stylesheet">
    <link href="{{ asset('/assets/sistema/lib/jquery-switchbutton/jquery.switchButton.css') }}" rel="stylesheet">
    <link href="{{ asset('/assets/sistema/lib/rickshaw/rickshaw.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/assets/sistema/lib/chartist/chartist.css') }}" rel="stylesheet">
