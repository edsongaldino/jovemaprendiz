<div class="row no-gutters">
    ...
    <div class="col-md-3" id="CeiE" @if(($empresa->tipo_cadastro ?? '') == 'CEI') style="display: block;" @else style="display: none;" @endif>
        <div class="form-group">
    ...
    <div class="col-md-3 mg-t--1 mg-md-t-0 CnpjE">
    ...
    <div class="row col-md-12 no-gutters" id="EmpresaMatriz" @if (isset($empresa) && (($empresa->tipo_empresa ?? '') == 'Filial')) style="display: block;" @else style="display: none;" @endif>
        ...
        <div class="col-md-4">
            <div class="form-group">
            <label class="form-control-label">CNPJ: <span class="tx-danger">*</span></label>
            <input class="form-control" type="text" id="cnpj_matriz" name="cnpj_matriz" value="{{ $empresa->cnpj_matriz ?? '' }}" placeholder="CNPJ da Matriz">
            </div>
        </div><!-- col-4 -->
        ...
        <div class="col-md-8">
            ...
            <input class="form-control" type="text" id="razao_social_matriz" name="razao_social_matriz" value="" placeholder="Razão Social (Preenchimento Automático)" readonly>
            </div>
        </div><!-- col-4 -->
        </div>
    ...
    @if (isset($empresa) && isset($empresa->inscricoes))
