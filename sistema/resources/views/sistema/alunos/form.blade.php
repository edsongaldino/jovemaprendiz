<div class="row no-gutters">
    ...
    <div class="col-md-4 mg-t--1 mg-md-t-0">
        ...
        <input class="form-control" type="text" name="data_nascimento" id="dateMask" value="{{ Helper::data_br($aluno->data_nascimento ?? '') }}" placeholder="00/00/0000" required>
        </div>
    </div><!-- col-4 -->
    ...
    <div class="col-md-12" id="dados-conjuge" @php if(isset($aluno->conjuge->id)): echo 'style="display: block;"'; else: echo 'style="display: block;"'; endif; @endphp>
        <div class="row no-gutters">
